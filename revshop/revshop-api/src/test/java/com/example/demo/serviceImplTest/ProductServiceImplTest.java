...
class ProductServiceImplTest {
	...
	void createProduct_shouldCreateSuccessfully() {
		...
		when(productRepository.existsBySellerIdAndNameIgnoreCaseAndCategory_Id(anyLong(), anyString(), anyLong()))
				.thenReturn(false);
	...
	void updateStock_shouldThrowException_whenNegative() {
		...
		assertThrows(BadRequestException.class, () -> productService.updateStock(1L, -1));
	}
