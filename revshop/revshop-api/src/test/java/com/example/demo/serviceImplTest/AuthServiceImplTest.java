...
class AuthServiceImplTest {
	...
	void register_emailAlreadyExists() {
		...
		assertThrows(UserAlreadyExistsException.class, () -> authService.register(request, "BUYER"));
	}
	...
	void forgotPassword_success() {
		...
		verify(emailService, times(1)).sendOtpEmail(eq("test@gmail.com"), anyString());
	}
	...
	void forgotPassword_userNotFound() {
		...
		assertThrows(UserNotFoundException.class, () -> authService.forgotPassword("unknown@gmail.com"));
	}
	...
	void resetPassword_success() {
		...
		PasswordResetToken token = new PasswordResetToken("test@gmail.com", "123456",
				LocalDateTime.now().plusMinutes(5), false);

		when(passwordResetTokenRepository.findByEmailAndOtpAndUsedFalse("test@gmail.com", "123456"))
	...
	void resetPassword_invalidOtp() {
		...
		when(passwordResetTokenRepository.findByEmailAndOtpAndUsedFalse("test@gmail.com", "999999"))
				.thenReturn(Optional.empty());

		assertThrows(InvalidOtpException.class, () -> authService.resetPassword("test@gmail.com", "999999", "pass"));
	}
}